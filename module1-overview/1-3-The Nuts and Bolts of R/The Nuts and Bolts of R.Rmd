...
```{r  numeric_types2, exercise = TRUE}
# Numeric atomic vector
grade2 <- 93
grade2
typeof(grade2)
...
Yay!:tada: We made it to the final data type: logical data. Logical data types in R are known as boolean data types. Logical data can only have two values: `TRUE` and `FALSE`.

```{r  logical_char, exercise = TRUE}
