...
Before we begin, please save the project file in Canvas titled microcred.Rproj in this current module. Save this .Rproj file in the folder you would like to keep your course materials for this class.
...
Once RStudio is open, in the bottom right window pane, double click on the `intro to R.R` file.

The video below will give you a tour of the RStudio environment using the `intro to R. R` file. Please follow along :)
...
You may have already figured out that you don't need to use `getwd()` for the `intro to R` file you're using in RStudio right now since it's part of an R Project. Using R Projects can be advantageous since RStudio recognizes the location of all the files stored within an R Project. 
