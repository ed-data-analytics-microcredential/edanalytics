...
In order to make functions useful, you must know 1) their purpose and 2) the types of inputs the functions needs, 3) and the structure in which you need to provide these inputs (e.g., for example `mean()` accepts multiples values that are separated by commas).
...
1. Create a new R script (lastname-R-module1) and save in your project folder for this course.
