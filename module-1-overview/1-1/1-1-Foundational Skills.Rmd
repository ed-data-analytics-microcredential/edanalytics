...
The HSB data can be found in your R project under the 'data' folder and is labeled [hsb.csv](https://raw.githubusercontent.com/ed-data-analytics-microcredential/edanalytics/main/data/hsb.csv).
The codebook, or data dictionary, for the data set can also be found in the 'data' folder and is labeled hsb-codebook.txt.
