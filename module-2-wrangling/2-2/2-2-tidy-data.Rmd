...
1. Open the R script you created in the previous module (lastname-R-task-2-1) that is saved in your project folder for this course. Go ahead and run this script to make sure your code works (we are going to pick up where we left off last time).
2. Read in the dataset called [hsb_future.csv](https://raw.githubusercontent.com/ed-data-analytics-microcredential/edanalytics/main/data/hsb_future.csv) located in your R project. This dataset is a brief one-question survey students in the `hsb` dataset completed. The question in this survey asked if students had future plans to attend college or trade school. `1` indicates the student plans on attending college or trade school and`0` indicates no plans of attending college or trade school. Go ahead and merge this dataset with the `hsbtransformed` and save as a new dataframe called `hsb_join`.
...
4. Save R script as lastname-R-task-2-2
5. Read the brief resource: [datawrangling-r-cheat-sheet.pdf](https://www.rstudio.com/wp-content/uploads/2015/02/data-wrangling-cheatsheet.pdf)
